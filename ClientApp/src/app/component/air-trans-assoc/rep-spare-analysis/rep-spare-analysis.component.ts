...
@Component({
  selector: 'app-rep-spare-analysis',
  templateUrl: './rep-spare-analysis.component.html',
  styleUrls: ['./rep-spare-analysis.component.css']
})
export class RepSpareAnalysisComponent implements OnInit, OnDestroy {
  meNumber: any = "";
  plannerName: string;
  resp: any;
  dialogValue: string;
  ...
  print_PDF(id: string): void {
    document.title = "REPAIRABLE SPARE ANALYSIS - " + id + " - " + moment().format('YYYY-MM-DD') + ".pdf";
    window.print();
  }
