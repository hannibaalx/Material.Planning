...
import { EoPartsShortage60 } from 'src/app/models/eo-parts-shortage60';
...
@Component({
  selector: 'app-part-shortage60',
  templateUrl: './part-shortage60.component.html',
  styleUrls: ['./part-shortage60.component.css']
})
export class PartShortage60Component implements OnInit {
  partShort60$: Observable<EoPartsShortage60[]>;
  bomDetail$: Observable<EoBomDetail[]>;
  currentDash8: string;
  ruleType: string = "60 Days Parts Shortage";
  ...
  ngOnInit() {
    ...
    this.partShort60$ = this.eoplannerService.getPartShortage60ByPlanner(plannerName.value);
  ...
  getplanner() { 
    this.partShort60$ = this.eoplannerService.getPartShortage60ByPlanner(this.planner);
  }
