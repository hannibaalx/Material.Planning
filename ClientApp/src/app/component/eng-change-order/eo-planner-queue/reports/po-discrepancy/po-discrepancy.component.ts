...
@Component({
  selector: 'app-po-discrepancy',
  templateUrl: './po-discrepancy.component.html',
  styleUrls: ['./po-discrepancy.component.css'],
    providers: [
...
export class PoDiscrepancyComponent implements OnInit {
