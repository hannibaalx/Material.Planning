...
@Component({
  selector: 'app-eco-station-readiness',
  templateUrl: './eco-station-readiness.component.html',
  styleUrls: ['./eco-station-readiness.component.css']
})
export class EcoStationReadinessComponent implements OnInit {
