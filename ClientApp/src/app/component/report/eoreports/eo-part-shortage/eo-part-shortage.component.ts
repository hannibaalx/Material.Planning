...
@Component({
  selector: 'app-eo-part-shortage',
  templateUrl: './eo-part-shortage.component.html',
  styleUrls: ['./eo-part-shortage.component.css']
})
export class EoPartShortageComponent implements OnInit, OnDestroy {
